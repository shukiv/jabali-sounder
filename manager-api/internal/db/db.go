...
func autoMigrateSQLite(dsn string) error {
	...
	if err := gormDB.AutoMigrate(&models.Server{}, &models.Heartbeat{}, &models.Admin{}, &models.MetricSample{}, &models.Session{}, &models.APIToken{}, &models.Notification{}, &models.AlertRule{}, &models.AlertChannel{}, &models.MaintenanceWindow{}, &models.MutedAlert{}, &models.AuditLog{}, &models.BackupRun{}); err != nil {
